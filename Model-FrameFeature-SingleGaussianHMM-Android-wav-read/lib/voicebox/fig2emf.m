...
%
% Inputs: h   optional figure handle [current figure]
%         s   file name which can include <m> for the top level
%                 mfile name and <n> for figure number ['<m>_<n>']
%         p   argument for call to figbolden if required
%                 or 0 for default argument [no figbolden call]
...
%      Version: $Id: fig2emf.m 1544 2012-03-09 17:15:26Z dmb $
%
