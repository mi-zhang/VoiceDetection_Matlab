function [cepstra,aspectrum,pspectrum] = melfcc_sg(specgram, sr, numcep, lifterexp, sumpower, dither, minfreq, maxfreq, nbands, bwidth, dcttype, fbtype, usecmp, modelorder)
...
%[wintime, hoptime, numcep, lifterexp, sumpower, preemph, dither, minfreq, maxfreq, nbands, bwidth, dcttype, fbtype, usecmp, modelorder] = ...
