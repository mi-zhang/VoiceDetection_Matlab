...
function main_matlab_check_energy_ratio_likelihood_false_positive_rate (audio_file)
...
%     noise_level = 0.02; % white noise level: 0.01 represents 1%.
    ...
    title([audio_file, ': LF / HF Ratio Feature Setting: 1KHz, Likelihood: ' num2str(voiced_liklihood_threshold) ' (log10)'], 'FontSize', 18);
    xlabel('LF / HF Ratio');
    ylabel('False Positive Rate (%)');

    % save the FPR curve
    saveas(gcf, [audio_file '_1KHz_energy_ratio_likelihood_FPR'], 'jpg');    
