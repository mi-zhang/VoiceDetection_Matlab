...
function  android_frame_feature_GMM_HMM_model_test (audio_file, speech_voiced_GMM_model, speech_unvoiced_GMM_model)
    ...
    features = load_android_features_nonspeech (audio_file);
        
    % calculate the likelihood (B)
    voiced_likelihood = pdf(speech_voiced_GMM_model, features);
    unvoiced_likelihood = pdf(speech_unvoiced_GMM_model, features);
