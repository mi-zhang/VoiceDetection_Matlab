...
function main_matlab_check_energy_ratio_false_positive_rate (audio_file)
...
%     noise_level = 0.02; % white noise level: 0.01 represents 1%.
    ...
    for j = 1:length(LF_HF_ratio_threshold_array)
        ...
        % filter out false positive based on LF_HF_ratio_threshold
    ...
    % save the FPR curve
    saveas(gcf, [audio_file '_1KHz_energy_ratio_FPR'], 'jpg');
