...
function frame_feature_HMM_model_main ()
...
%     features_s6 = compute_features_speech('speech_t2');
%     features_s7 = compute_features_speech('speech_indoor_meeting_t2');
%     features_s8 = compute_features_speech('speech_indoor_meeting_t3');
%     features_s9 = compute_features_speech('speech_indoor_meeting_t4');
%     features_s10 = compute_features_speech('speech_indoor_meeting_t5');
%     features_s11 = compute_features_speech('speech_indoor_meeting_t6');
%     features_s12 = compute_features_speech('speech_indoor_meeting_t7');
...
%     features_s6_unvoiced = compute_features_speech_unvoiced('speech_t2');
%     features_s7_unvoiced = compute_features_speech_unvoiced('speech_indoor_meeting_t2');
%     features_s8_unvoiced = compute_features_speech_unvoiced('speech_indoor_meeting_t3');
%     features_s9_unvoiced = compute_features_speech_unvoiced('speech_indoor_meeting_t4');
%     features_s10_unvoiced = compute_features_speech_unvoiced('speech_indoor_meeting_t5');
%     features_s11_unvoiced = compute_features_speech_unvoiced('speech_indoor_meeting_t6');
%     features_s12_unvoiced = compute_features_speech_unvoiced('speech_indoor_meeting_t7');
...
%     % class 1: speech (voiced) 
% %     features_speech_voiced = [features_s1; features_s2; features_s3; features_s4; features_s5; features_s6; features_s7; features_s8; features_s9; features_s10];
%     features_speech_voiced = [
%         features_s1; features_s2; features_s3; features_s4; features_s5; features_s6;
%         features_s7; features_s8; features_s9; features_s10; features_s11; features_s12
%         ];
%    
...
%     speech_voiced_gaussian_model = frame_feature_HMM_model_train(features_speech_voiced(:, 1:number_of_features));
%     speech_unvoiced_gaussian_model = frame_feature_HMM_model_train(features_speech_unvoiced(:, 1:number_of_features));
%     
%     % 2-4: save the model
%     prior = [0.5; 0.5];
...
%     save('voicing_parameters.mat', 'prior', 'transmat', 'speech_mu', 'speech_cov');
...
%     save('global_parameters.mat', 'framesize', 'framestep', 'noise_level', 'num_of_framestep_for_RSE', 'sampling_rate');
    ...
    % class 1: speech (voiced)
    frame_feature_HMM_model_test ('radio_t1', number_of_features);
    frame_feature_HMM_model_test ('speech_t2', number_of_features);
    frame_feature_HMM_model_test ('speech_t3', number_of_features);
    frame_feature_HMM_model_test ('speech_t4', number_of_features);    
    frame_feature_HMM_model_test ('speech_indoor_meeting_t1', number_of_features);
    frame_feature_HMM_model_test ('speech_indoor_meeting_t2', number_of_features);
    frame_feature_HMM_model_test ('speech_indoor_meeting_t3', number_of_features);
    frame_feature_HMM_model_test ('speech_indoor_meeting_t4', number_of_features);
    frame_feature_HMM_model_test ('speech_indoor_meeting_t5', number_of_features);
    frame_feature_HMM_model_test ('speech_indoor_meeting_t6', number_of_features);
    frame_feature_HMM_model_test ('speech_indoor_meeting_t7', number_of_features);    
    
    frame_feature_HMM_model_test ('speech_phonecall_t1', number_of_features);
    frame_feature_HMM_model_test ('speech_phonecall_t2', number_of_features);
    
    frame_feature_HMM_model_test ('speech_indoor_restaurant_t1', number_of_features);
    
    frame_feature_HMM_model_test ('speech_indoor_hallway_t1', number_of_features);
    frame_feature_HMM_model_test ('speech_indoor_hallway_t3', number_of_features);
    
    frame_feature_HMM_model_test ('speech_outdoor_standing_t1', number_of_features);
    frame_feature_HMM_model_test ('speech_outdoor_standing_t3', number_of_features);    
    
    frame_feature_HMM_model_test ('speech_outdoor_walking_t1', number_of_features);
    frame_feature_HMM_model_test ('speech_outdoor_walking_t3', number_of_features);
    
    frame_feature_HMM_model_test ('speech_outdoor_bus_t1', number_of_features);  
    
    % class 2: Ambient
    % - 'silent'
    frame_feature_HMM_model_test ('silent_t1', number_of_features);
    % - 'walk'
    frame_feature_HMM_model_test ('walk_t1', number_of_features);
    frame_feature_HMM_model_test ('walk_t2', number_of_features);
    frame_feature_HMM_model_test ('walk_t3', number_of_features);
    frame_feature_HMM_model_test ('walk_t4', number_of_features);
    frame_feature_HMM_model_test ('walk_t5', number_of_features);    
    % - 'bus'
    frame_feature_HMM_model_test ('bus_t1', number_of_features);
    frame_feature_HMM_model_test ('bus_t2', number_of_features);
    frame_feature_HMM_model_test ('bus_t3', number_of_features);
    frame_feature_HMM_model_test ('bus_t4', number_of_features);
    frame_feature_HMM_model_test ('bus_t5', number_of_features);    
    % - 'cafe'
    frame_feature_HMM_model_test ('cafe_t1', number_of_features);
    frame_feature_HMM_model_test ('cafe_t2', number_of_features);
    frame_feature_HMM_model_test ('cafe_t3', number_of_features);
    frame_feature_HMM_model_test ('cafe_t4', number_of_features);        
    frame_feature_HMM_model_test ('cafe_t5', number_of_features);
    
    % class 3: Music
    % - 'classical'         
%     frame_feature_HMM_model_test ('classical_t1', number_of_features);
%     frame_feature_HMM_model_test ('classical_t2', number_of_features);
%     frame_feature_HMM_model_test ('classical_t3', number_of_features);
%     frame_feature_HMM_model_test ('classical_t4', number_of_features);        
%     % - 'pop'
%     frame_feature_HMM_model_test ('pop_t1', number_of_features);
%     frame_feature_HMM_model_test ('pop_t2', number_of_features);
%     frame_feature_HMM_model_test ('pop_t3', number_of_features);
%     frame_feature_HMM_model_test ('pop_t4', number_of_features);
%     frame_feature_HMM_model_test ('pop_t5', number_of_features);        
%     frame_feature_HMM_model_test ('pop_t6', number_of_features);
%     
%     % class 4: TV
%     frame_feature_HMM_model_test ('tv_t1', number_of_features);
%     frame_feature_HMM_model_test ('tv_t2', number_of_features);
%     frame_feature_HMM_model_test ('tv_t3', number_of_features);
%     frame_feature_HMM_model_test ('tv_t4', number_of_features);
%     frame_feature_HMM_model_test ('tv_t5', number_of_features);        
%     frame_feature_HMM_model_test ('tv_t6', number_of_features);
