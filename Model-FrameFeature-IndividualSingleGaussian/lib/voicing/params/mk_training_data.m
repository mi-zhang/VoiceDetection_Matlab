...
if(exist('f1') ~= 1 || exist('m1') ~= 1 || exist('s1') ~= 1 || exist('a1') ~= 1)
    [fs1,m1,s1,a1] = voicing_features_all(training.A1, framesize, framestep,noise_level,num_mean_frames,sr);
    disp('A1 done');
else
...
if(exist('f2') ~= 1 || exist('m2') ~= 1 || exist('s2') ~= 1 || exist('a2') ~= 1)
    [fs2,m2,s2,a2] = voicing_features_all(training.A2, framesize, framestep,noise_level,num_mean_frames,sr);
    disp('A2 done');
else
...
if(exist('f3') ~= 1 || exist('m3') ~= 1 || exist('s3') ~= 1 || exist('a3') ~= 1)
    [fs3,m3,s3,a3] = voicing_features_all(training.A3, framesize, framestep,noise_level,num_mean_frames,sr);
    disp('A3 done');
else
...
if(exist('f4') ~= 1 || exist('m4') ~= 1 || exist('s4') ~= 1 || exist('a4') ~= 1)
    [fs4,m4,s4,a4] = voicing_features_all(training.A4, framesize, framestep,noise_level,num_mean_frames,sr);
    disp('A4 done');
else
...
if(exist('f5') ~= 1 || exist('b5') ~= 1 || exist('m5') ~= 1 || exist('s5') ~= 1 || exist('a5') ~= 1)
    [fs5,m5,s5,a5] = voicing_features_all(training.A5, framesize, framestep,noise_level,num_mean_frames,sr);
    disp('A5 done');
else
...
if(exist('f6') ~= 1 || exist('m6') ~= 1 || exist('s6') ~= 1 || exist('a6') ~= 1)
    [fs6,m6,s6,a6] = voicing_features_all(training.A6, framesize, framestep,noise_level,num_mean_frames,sr);
    disp('A6 done');
else
...
if(exist('f7') ~= 1 || exist('m7') ~= 1 || exist('s7') ~= 1 || exist('a7') ~= 1)
    ...
    [fs7,m7,s7,a7] = voicing_features_all(sig7, framesize, framestep,noise_level,num_mean_frames,sr);
    disp('A7 done');
else
