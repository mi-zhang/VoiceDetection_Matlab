...
data = sample_pomdp(prior0, transmat0, obsmat0, act);
...
for t=2:T
  ...
  [transmat1, obsmat1, ess_trans, ess_emit, gamma, ll] = online_em(...
...
verbose = 1;
thresh = 1e-3;
[LL2, prior2, transmat2, obsmat2] = learn_dhmm(data, prior2, transmat2, obsmat2, niter, thresh, verbose, act);
LL2 = LL2 / T;
