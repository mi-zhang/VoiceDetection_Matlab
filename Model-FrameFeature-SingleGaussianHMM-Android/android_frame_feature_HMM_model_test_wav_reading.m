...
function  android_frame_feature_HMM_model_test_wav_reading (audio_file, number_of_features)
    ...
    features = load_android_features_nonspeech_wav_reading (audio_file);
        
    % load trained voice detection HMM model parameters
    load android_voicing_parameters_wav_reading.mat
...
%         fprintf(fid,'%s\r\n', 'TPR, FPR, Accuracy, Precision, Recall');
    ...
    % save the plot
    saveas(gcf, [audio_file '_frame_feature_HMM_model_android_wav_reading'], 'jpg');
